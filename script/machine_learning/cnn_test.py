...
result_save_dir_path = f'data/result/cnn/'
result_save_path = result_save_dir_path + f'result_cnn_{task}_{fold}.json'
result_mean_save_path = result_save_dir_path + f'result_mean_cnn_{task}_{fold}.json'
...
def main():
    ...
    for name in test_list:
        print(f'!!!!!!!!!! {name} !!!!!!!!!!')
        listdata = cnn_module.load_tsv(name)
